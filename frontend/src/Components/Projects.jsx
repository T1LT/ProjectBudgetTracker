...
const Transactions = () => {
	...
	const emptyRows =
		page > 0
			? Math.max(0, (1 + page) * rowsPerPage - projectData.length)
			: 0;
						...
						>
							<form>
								...
								<input
									...
									id="projdate"
									name="projdate"
									defaultValue={formProjectData[
										"projdate"
									].slice(0, 10)}
									onChange={handleChange}
									required
								/>
								<label htmlFor="projmanager">
									Project Manager:{" "}
								</label>
								<input
									type="text"
								...
								<label
									htmlFor="projbudget"
									className={
										showError ? "labelError" : "tempclass"
									}
								>
									Project Budget:{" "}
								</label>
								<input
									...
									onChange={handleChange}
									className={
										showError ? "errorClass" : "tempclass"
									}
									required
								/>
								{showError && (
